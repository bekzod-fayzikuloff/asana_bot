...
EXPIRED_TEXT = "Задача выполнена? Если да, то укажи в сроке выполнения текущую дату и напиши комментарий к данной задаче. Не забудь отметить в комментарии меня!"  # noqa
